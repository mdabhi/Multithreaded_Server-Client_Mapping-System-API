...
/**
 * @brief Adds road names for the edges on the Map.
 *
 * Usage:
 * @code
...
/**
 * @brief Adds a road name for an edge on the Map.
 *
 * Usage:
 * @code
 *
 * char roadInfo[EDGE_NAME_SIZE];
 * char roadname[ROAD_NAME_SIZE] = "Ring Road";
 *
 * memcpy(roadInfo, "DC-RR", EDGE_NAME_SIZE);
 *
 * road(roadInfo, roadname);
 * @endcode
 * @param edges A char array of Name's of edges formed by concatenating two vertex names by a '-'.
 * @param roadname Pointer to a character array which holds the name of the road.
 * @return Success: 0.
 * @return Failure: -1.
 * @see freeGraph
 */
int edgeAddRoad(char* edgename, char* roadname);
 ...
 * @param route Adress of an char array which returns the route
 * @param size Adress of an integer array which returns the size of the route
 * @return Success: Returns the time.
 * @return Failure: -1.
 * @see freeGraph
 */
